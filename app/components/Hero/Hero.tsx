  ...
  return (
    <section className="relative pl-6 flex flex-row z-20 mx-auto md:gap-[50px] md:mx-[-40px] top-[-90px] justify-center">
      <div className="flex flex-col gap-[13px] items-start md:items-start mt-0 md:mt-10 text-left md:text-center">
        <h1 className="py-3 mt-0 text-xl md:text-[50px] font-bold bg-clip-text bg-gradient-to-r from-[#2f39c6] to-[#aad3f8] dark:from-secondary dark:to-primary text-transparent transition-colors duration-1000 ease-in-out">
          Hello I&apos;m Sarah, I&apos;m a 
          <span className='block text-[27px] md:text-[40px] highlight-l mt-[10px]'>Web Developer</span>
        </h1>
        <p className='text-sm md:text-lg max-w-[90%] md:max-w-full  md:text-left'>
      ...
      <div className="relative w-full md:w-auto flex justify-start mt-6 md:mt-0">
